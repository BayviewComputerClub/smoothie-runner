...
It is generated from these files:
	runner/smoothie-runner.proto

It has these top-level messages:
	Empty
	ProblemTestDataHashRequest
	ProblemTestDataHashResponse
...
type ProblemTestDataHashRequest struct {
	ProblemId string `protobuf:"bytes,1,opt,name=problemId" json:"problemId,omitempty"`
}
...
func (*ProblemTestDataHashRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (*ProblemTestDataHashResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
type UploadTestDataRequest struct {
	...
	TestDataHash      string `protobuf:"bytes,3,opt,name=testDataHash" json:"testDataHash,omitempty"`
	FinishedUploading bool   `protobuf:"varint,4,opt,name=finishedUploading" json:"finishedUploading,omitempty"`
}
...
func (*UploadTestDataRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (*UploadTestDataResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func (*ServiceHealth) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
...
func (*TestSolutionRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func (*Solution) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
type Problem struct {
	ProblemId    string         `protobuf:"bytes,1,opt,name=problemId" json:"problemId,omitempty"`
	TestDataHash string         `protobuf:"bytes,2,opt,name=testDataHash" json:"testDataHash,omitempty"`
	Grader       *ProblemGrader `protobuf:"bytes,3,opt,name=grader" json:"grader,omitempty"`
	TimeLimit    float64        `protobuf:"fixed64,4,opt,name=timeLimit" json:"timeLimit,omitempty"`
	MemLimit     float64        `protobuf:"fixed64,5,opt,name=memLimit" json:"memLimit,omitempty"`
}

func (m *Problem) Reset()                    { *m = Problem{} }
func (m *Problem) String() string            { return proto.CompactTextString(m) }
func (*Problem) ProtoMessage()               {}
func (*Problem) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }
...
func (*ProblemGrader) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }
...
type TestSolutionResponse struct {
	...
	TestDataNeedUpload bool            `protobuf:"varint,4,opt,name=testDataNeedUpload" json:"testDataNeedUpload,omitempty"`
}
...
func (*TestSolutionResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{10} }
...
func (*TestCaseResult) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }
...
func (c *smoothieRunnerAPIClient) GetProblemTestDataHash(ctx context.Context, in *ProblemTestDataHashRequest, opts ...grpc.CallOption) (*ProblemTestDataHashResponse, error) {
	...
	err := grpc.Invoke(ctx, "/SmoothieRunnerAPI/GetProblemTestDataHash", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *smoothieRunnerAPIClient) UploadProblemTestData(ctx context.Context, opts ...grpc.CallOption) (SmoothieRunnerAPI_UploadProblemTestDataClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_SmoothieRunnerAPI_serviceDesc.Streams[0], c.cc, "/SmoothieRunnerAPI/UploadProblemTestData", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *smoothieRunnerAPIClient) TestSolution(ctx context.Context, opts ...grpc.CallOption) (SmoothieRunnerAPI_TestSolutionClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_SmoothieRunnerAPI_serviceDesc.Streams[1], c.cc, "/SmoothieRunnerAPI/TestSolution", opts...)
	if err != nil {
		return nil, err
	}
...
func init() { proto.RegisterFile("runner/smoothie-runner.proto", fileDescriptor0) }
